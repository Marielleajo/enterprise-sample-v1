...
import {ADD_FEES_CATEGORY, UPDATE_FEES_CATEGORY} from "../../../../APIs/EWallet";
import {useSnackbar} from "../../../../Contexts/SnackbarContext";
import {removeNullKeys} from "../../../Utils/Functions";

const Manage_Fee_Category = ({
                                 open,
                                 handleClose,
                                 isEdit,
                                 categoryData,
    ...
    const formik = useFormik({
        initialValues: {
            ...
            // HasMultiple: categoryData?.hasMultiple || false,
        },
        validationSchema: validationSchema,
        onSubmit: async (values) => {
            try {
                const payload = {
                    recordGuid: isEdit ? categoryData?.recordGuid : undefined,
                ...
                const response = isEdit
                    ? await UPDATE_FEES_CATEGORY({postData: removeNullKeys(payload)})
                    : await ADD_FEES_CATEGORY({postData: removeNullKeys(payload)});
                                ...
                                >
                                    {languageChangeLoading || isLoading ? (
                                        ...
                                        <>
                                            ...
                                            {/*            />*/}
                                            {/*        }*/}
                                            {/*        label="Enable Multiple Content Formats"*/}
                                            {/*    />*/}
                                            {/*</Grid>*/}
                                        </>
                                    )}
...
export default withTranslation("translation")(Manage_Fee_Category);
