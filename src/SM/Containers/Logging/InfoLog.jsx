...
import { GET_INFO_LOGS } from "../../../APIs/Logging";
...
function InfoLog() {
  ...
  const getAllInfoLogs = async () => {
    ...
    try {
      ...
      let response = await GET_INFO_LOGS({
        token,
        search: "",
          ...
          >
            <Grid item xs={12} md={4}>
              <Breadcrumbs aria-label="breadcrumb" className="breadcrumb">
                <Typography className="BreadcrumbsPage">Info Logs</Typography>
              </Breadcrumbs>
            </Grid>
            <Grid
              item
...
export default GetActions(InfoLog);
