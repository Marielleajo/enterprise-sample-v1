...
import { ADD_SENDER_REASON, EDIT_SENDER_REASON } from "../../../APIs/Reasons";
    ...
    onSubmit: async (values) => {
      if (type == "add") {
        ...
        try {
          ...
          let response = await ADD_SENDER_REASON({ postData: data });
        ...
        try {
          ...
          let response = await EDIT_SENDER_REASON({ postData: data });
          if (response?.data?.success) {
